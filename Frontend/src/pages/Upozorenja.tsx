      ...
      <div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <div className="p-4 rounded-lg border border-gray-200 bg-white dark:border-slate-700 dark:bg-slate-900/50">
            <p className="text-sm text-gray-600 dark:text-slate-300">Kritično</p>
          ...
          <div className="p-4 rounded-lg border border-gray-200 bg-white dark:border-slate-700 dark:bg-slate-900/50">
            <p className="text-sm text-gray-600 dark:text-slate-300">Upozorenje</p>
          ...
          <div className="p-4 rounded-lg border border-gray-200 bg-white dark:border-slate-700 dark:bg-slate-900/50">
            <p className="text-sm text-gray-600 dark:text-slate-300">Informacija</p>
            <p className="text-2xl font-bold text-amber-700 dark:text-amber-300">
