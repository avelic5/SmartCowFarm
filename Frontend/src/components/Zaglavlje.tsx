...
export function Zaglavlje({ isMobileNavOpen = false, onToggleMobileNav }: ZaglavljeProps) {
  ...
  return (
    <header
      className={`sticky top-0 bg-white border-b border-gray-200 z-40 shadow-sm dark:border-slate-800 dark:bg-slate-900 ${
    ...
    >
      <div className="flex flex-col gap-3 px-4 py-3 md:h-16 md:flex-row md:items-center md:gap-4 md:px-8 md:py-0">
        ...
        <div className="hidden md:flex md:items-center md:gap-4 md:ml-auto md:justify-end">
          ...
          <div className="flex items-center gap-3 border-l border-gray-200 pl-4 dark:border-slate-800">
            ...
            <div className="w-10 h-10 bg-linear-to-br from-green-500 to-blue-600 rounded-full flex items-center justify-center">
